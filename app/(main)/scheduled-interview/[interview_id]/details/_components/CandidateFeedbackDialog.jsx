        ...
        <div className="fixed inset-0 flex items-center justify-center px-6" style={{ zIndex: 9999 }}>
          ...
          <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-lg mx-auto max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b">
              <h2 className="my-5 font-bold text-lg text-gray-800">Feedback</h2>
            ...
            <div className="px-6 py-5">
              ...
              <div className="flex justify-between items-center bg-gray-50 rounded-xl p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">{candidate?.userEmail}</p>
                ...
                <div className="text-center bg-white rounded-xl px-4 py-2 shadow-sm border">
                  ...
                  <p className="text-green-600 font-bold text-2xl">6/10</p>
                </div>
              </div>

              {/* Skills Assessment */}
              <div className="mt-5">
                <h2 className="font-bold text-gray-800 mb-3">Skills Assessment</h2>
                <div className="grid grid-cols-2 gap-3">
                  {[
                    { label: "Technical Skills", value: feedback?.rating?.technicalSills },
              ...
              {/* Performance Summary */}
              <div className="mt-5">
                <h2 className="font-bold text-gray-800 mb-2">Performance Summary</h2>
                <div className="p-4 bg-gray-50 rounded-xl text-sm text-gray-700 leading-6 border border-gray-100">
                  {typeof feedback?.summary === "string" ? (
                    ...
                    feedback.summary.map((item, index) => <p key={index} className="mb-1">{item}</p>)
                  ) : (
              ...
              {/* Recommendation */}
              <div className={`p-4 mt-4 flex items-center justify-between rounded-xl ${feedback?.Recommendation === "No" ? "bg-red-50  border-red-200" : "bg-green-50 border-green-200"}`}>
                <div className="mr-4">
                  <h2 className={`font-bold text-sm ${feedback?.Recommendation === "No" ? "text-red-700" : "text-green-700"}`}>
                    Recommendation Msg:
                  </h2>
                  <p className={`text-sm mt-1 ${feedback?.Recommendation === "No" ? "text-red-500" : "text-green-500"}`}>
                    {feedback?.RecommendationMsg}
                  </p>
                </div>
                <Button className={`shrink-0 ${feedback?.Recommendation === "No" ? "bg-red-600 hover:bg-red-700" : "bg-green-600 hover:bg-green-700"}`}>
                  Send Msg
                </Button>
              </div>
            </div>
